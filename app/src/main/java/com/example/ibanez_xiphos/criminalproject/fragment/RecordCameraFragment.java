...
public class RecordCameraFragment extends Fragment {
    ...
    public static final String EXTRA_PHOTO_FILENAME = "RecordCameraFragment.filename";
    ...
    public void onResume() {
        ...
        try {
            ...
            Toast.makeText(getContext(), "Another application uses the camera", Toast.LENGTH_SHORT).show();
